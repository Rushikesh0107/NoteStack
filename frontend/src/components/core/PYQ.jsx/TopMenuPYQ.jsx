...
import { getPYQ } from '../../../services/operations/pyqApi';
  ...
  return (
    <>
      {isMobile ? (
        ...
        <div className="flex justify-around gap-10 pl-10 pr-10 pb-6">
          {/* Department Dropdown */}
