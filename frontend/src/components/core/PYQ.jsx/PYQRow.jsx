...
function PYQRow({ title, paperLink }) {
  // Modify the Cloudinary URL to include 'fl_attachment' for forced download
    const modifiedLink = paperLink.replace('/upload/', '/upload/fl_attachment/')
